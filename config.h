...
static const char *fonts[]          = { "Inconsolata:Regular:size=10" };
static const char dmenufont[]       = "Inconsolata:Regular:size=10";
...
static const char *volumeupcmd[]  = { "amixer", "-q", "sset", "Master", "5%+", "unmute", NULL };
static const char *volumedowncmd[]  = { "amixer", "-q", "sset", "Master", "5%-", "unmute", NULL };
